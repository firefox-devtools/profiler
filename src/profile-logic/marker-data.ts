 ...
 *
 * @param timestampStr - Pre-formatted timestamp from formatLogTimestamp()
 * @param processName  - Thread's process name (e.g. "GeckoMain")
 * @param pid          - Process ID
 * @param threadName   - Thread name (e.g. "Compositor")
 * @param data         - The LogMarkerPayload from the marker table
 * @param moduleName   - For the new format: module name resolved from the
 *                       profile string table (markers.name). Ignored for the
 *                       legacy format, which encodes the module in data.module.
 * @param stringArray  - Profile shared string table, used to resolve data.level
 *                       in the new format.
 */
