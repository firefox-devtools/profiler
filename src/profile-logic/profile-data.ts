...
export function reserveFunctionsInThread(
  ...
  const reservedFunctionsForResources: Map<
    IndexIntoResourceTable,
    IndexIntoFuncTable
  > = new Map();
...
export function extractProfileFilterPageData(
  ...
  const pageDataByTabID: Map<TabID, ProfileFilterPageData> = new Map();
...
export function nudgeReturnAddresses(thread: RawThread): RawThread {
  ...
  const ipFrames: Set<IndexIntoFrameTable> = new Set();
  ...
  const mapForSamplingSelfStacks: Map<
    null | IndexIntoStackTable,
    null | IndexIntoStackTable
  > = new Map();
  const mapForBacktraceSelfStacks: Map<
    null | IndexIntoStackTable,
    null | IndexIntoStackTable
  > = new Map();
...
export function computeTabToThreadIndexesMap(
  ...
  const tabToThreadIndexesMap: Map<TabID, Set<ThreadIndex>> = new Map();
