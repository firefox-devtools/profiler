...
const CATEGORY_TITLE =
  "Each sample's call stack is used to place it in an " +
  'appropriate category.';
const SAMPLE_TITLE =
  'The profiler samples the call stack at a fixed rate. Each of ' +
  'these samples is categorized and then summed over the course of the recording.';
const PERCENT_TIME_TITLE =
  'The percentage of time represents the percentage of how ' +
...
class SummarizeProfileHeader extends PureComponent {
  render() {
    ...
    return (
      <div>
        <div className="summarize-profile-thread" colSpan="3">
          {threadName} Thread, {processType} process
        </div>
        <div className="summarize-profile-header">
          ...
          <div className="summarize-profile-details">
            <div className="summarize-profile-text" title={CATEGORY_TITLE}>
              Category
            </div>
            <div className="summarize-profile-numeric" title={SAMPLE_TITLE}>
              Samples
            </div>
            <div
