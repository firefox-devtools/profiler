...
const TIMELINE_SETTINGS_HEIGHT = 25;
// Account for the border in the outer height.
export const TIMELINE_SETTINGS_OUTER_HEIGHT = TIMELINE_SETTINGS_HEIGHT + 1;
    ...
    return (
      <>
        <div
          ...
          style={{
            '--timelineSettingsHeight': `${TIMELINE_SETTINGS_HEIGHT}px`,
          }}
        >
