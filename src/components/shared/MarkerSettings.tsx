...
type OwnProps = {
  readonly copyTable?: (format: 'plain' | 'markdown', onWarning: (message: string) => void) => void;
};
...
type State = {
  ...
  readonly copyTableWarning: string | null;
};
