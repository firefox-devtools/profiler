...
class LanguageSwitcherImpl extends React.PureComponent<Props> {
  ...
  render() {
    ...
    return (
      <Localized
        id="MenuButtons--languageSwitcher--select"
        attrs={{ title: true }}
      >
        <div className="menuButtonsButton menuButtonsLanguageSwitcherContainer menuButtonsButton-hasLeftBorder menuButtonsButton-hasIcon">
          <select
            id="menuButtonsLanguageSwitcher"
            className="menuButtonsLanguageSwitcherSelect"
