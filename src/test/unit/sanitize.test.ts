...
import { addPIICategoriesToMarkerSchema } from '../../profile-logic/marker-schema';
import {
...
describe('sanitizePII', function () {
  ...
  it('should sanitize URLs inside text markers after upgrading an old processed profile', function () {
