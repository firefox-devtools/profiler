...
describe('mergeProfilesForDiffing function', function () {
  ...
  it('merges the nativeSymbols tables correctly', function () {
    ...
    const stringTableA = UniqueStringArray.cachedTableForArray(
      threadA.stringArray
    );
    const stringTableB = UniqueStringArray.cachedTableForArray(
      threadB.stringArray
    );
...
describe('mergeThreads function', function () {
  ...
  it('merges CompositorScreenshot marker urls properly', function () {
    ...
    const stringTable1 = UniqueStringArray.cachedTableForArray(
      thread1.stringArray
    );
    const stringTable2 = UniqueStringArray.cachedTableForArray(
      thread2.stringArray
    );
