...
import type { UploadedProfileInformation } from 'firefox-profiler/types';
import type { RouteRequest } from '../fixtures/mocks/fetch-mock-utils';
autoMockIndexedDB();
...
async function storeProfileInformations(
  listOfProfileInformations: UploadedProfileInformation[]
) {
...
describe('ListOfPublishedProfiles', () => {
  function setup(props: { withActionButtons?: boolean; limit?: number } = {}) {
  ...
  describe('profile deletion', () => {
    function mockFetchForDeleteProfile({
      ...
      window.fetchMock
        .catch(404) // Catchall
        .route(endpointUrl, ({ options }: RouteRequest) => {
