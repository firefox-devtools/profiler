...
describe('app/TabSelectorMenu', () => {
  function setup() {
    ...
    profile.threads[0].usedInnerWindowIDs = [extraPageData.parentInnerWindowIDsWithChildren];
    ...
    profile.threads[1].usedInnerWindowIDs = [extraPageData.secondTabInnerWindowIDs[0]];
  ...
  it('should render sanitized page urls correctly', () => {
    ...
    profile.threads[0].usedInnerWindowIDs = [extraPageData.parentInnerWindowIDsWithChildren, extraPageData.secondTabInnerWindowIDs[0]];
    // TODO: refer to these innerWindowIDs from the frames
