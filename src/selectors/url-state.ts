...
export const getProfileNamesToCompare: Selector<string[] | null> = (state) =>
  getUrlState(state).profileNamesToCompare;
...
export const getSourceViewSourceIndex: Selector<IndexIntoSourceTable | null> = (
  state
