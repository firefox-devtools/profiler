...
export function getStackAndSampleSelectorsPerThread(
  ...
  // call-node-info.ts.
  const getLowerWingCallNodeInfo: Selector<LowerWingCallNodeInfo> =
    createSelector(
      _getNonInvertedCallNodeInfo,
      ProfileSelectors.getDefaultCategory,
      (state: State) =>
  ...
  const getFilteredCtssSampleRelations: Selector<SampleRelations> =
    createSelector(
  ...
  const getPreviewFilteredCtssSampleRelations: Selector<SampleRelations> =
    createSelector(
      getFilteredCtssSampleRelations,
      (state: State) =>
        threadSelectors.getPreviewFilteredCtssSampleIndexOffsets(state),
      (state: State) =>
        threadSelectors.getFilteredCtssSampleIndexOffsets(state),
      (filteredRelations, [b, e], [fb]) =>
        filteredRelations.subarray(b - fb, e - fb)
    );
  ...
  const getSampleRelationsForFunctionListTab: Selector<SampleRelations> =
    createSelector(
      getSampleCallNodesForFilteredThread,
      _getCallNodeTable,
      getSelectedFunctionIndex,
      (sampleCallNodes, callNodeTable, selectedFunctionIndex) =>
        ProfileData.getSampleRelationsToFunction(
          sampleCallNodes,
  ...
  const getPreviewFilteredCtssSampleRelationsToSelectedFunction: Selector<SampleRelations> =
    createSelector(
  ...
  const getLowerWingFlameGraphTiming: Selector<FlameGraph.LowerWingFlameGraphTiming> =
    createSelector(
      getLowerWingCallNodeInfo,
      getCallNodeSelfAndSummary,
      _getCallNodeTable,
  ...
  const getLowerWingFlameGraphMaxDepthPlusOne: Selector<number> =
    createSelector(
      _getCallNodeTable,
      getSelectedFunctionIndex,
  ...
  return {
    ...
    getSampleCallNodesForFilteredThread,
    getSampleRelationsToSelectedNodeInFilteredThread,
    getSampleRelationsForFunctionListTab,
    getPreviewFilteredCtssSampleCallNodes,
    getPreviewFilteredCtssSampleRelations,
    getPreviewFilteredCtssSampleRelationsToSelectedFunction,
