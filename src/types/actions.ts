...
type ReceiveProfileAction =
  ...
  | { readonly type: 'PROCESS_PROFILE_FROM_ZIP_FILE', readonly pathInZipFile: string }
  | { readonly type: 'FAILED_TO_PROCESS_PROFILE_FROM_ZIP_FILE', readonly error: any }
  | { readonly type: 'DISMISS_PROCESS_PROFILE_FROM_ZIP_ERROR' }
  | { readonly type: 'RETURN_TO_ZIP_FILE_LIST' }
  | { readonly type: 'FILE_NOT_FOUND_IN_ZIP_FILE', readonly pathInZipFile: string }
  | { readonly type: 'REQUESTING_SYMBOL_TABLE', readonly requestedLib: RequestedLib }
  | { readonly type: 'RECEIVED_SYMBOL_TABLE_REPLY', readonly requestedLib: RequestedLib }
  ...
  | { readonly type: 'WAITING_FOR_PROFILE_FROM_URL', readonly profileUrl: string | null }
...
type UrlEnhancerAction =
  ...
  | { readonly type: 'UPDATE_URL_STATE', readonly newUrlState: UrlState | null };
...
type UrlStateAction =
  ...
  | { readonly type: 'COMMIT_RANGE', readonly start: number, readonly end: number }
  | {
  ...
  | { readonly type: 'CHANGE_MARKER_SEARCH_STRING', readonly searchString: string }
  ...
  | { readonly type: 'CHANGE_PROFILE_NAME', readonly profileName: string | null }
  | {
...
export type IconWithClassName = { readonly icon: string, readonly className: string };
type IconsAction =
  | {
...
type SourcesAction =
  | { readonly type: 'SOURCE_CODE_LOADING_BEGIN_URL', readonly file: string, readonly url: string }
  | { readonly type: 'SOURCE_CODE_LOADING_BEGIN_BROWSER_CONNECTION', readonly file: string }
  | { readonly type: 'SOURCE_CODE_LOADING_SUCCESS', readonly file: string, readonly code: string }
  | {
