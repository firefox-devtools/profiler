 ...
 *   so it needs to be JSON-compatible, and it should avoid duplication and it
 *   is encouraged to use more compact data representations.
 ...
 *
 * These are the current differences between the derived Thread and RawThread:
 *
 *  - Thread has a isDerivedThread member (temporary)
 */
export type Thread = {|
