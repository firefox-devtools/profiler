...
import type { IndexIntoFuncTable, ThreadIndex } from './profile';
...
export type TracingMarkerWithPayload<Payload> = {
  start: Milliseconds,
  dur: Milliseconds,
  name: string,
  title: string | null,
...
export type TracingMarker = TracingMarkerWithPayload<MarkerPayload>;
